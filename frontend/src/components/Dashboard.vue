...
<!-- <template>
  ...
  <div class="min-w-0 flex-1">
    <h2 class="mt-3 ml-5 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Shortener Link Apps</h2>
  ...
  <div class="mt-5 mr-5 flex lg:mt-0 lg:ml-4">
    ...
    <span class="mt-6 sm:ml-3">
      <button @click="logout" type="button" class="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
    ...
    <!-- <div class="relative ml-3 sm:hidden"> -->
      ...
      <!-- <div class="absolute right-0 z-10 mt-2 -mr-1 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="mobile-menu-button" tabindex="-1">
        ...
        <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="mobile-menu-item-1">Logout</a>
      </div> -->
    <!-- </div> -->
  </div>
</div>
