...
<!-- <template>
  ...
  <template>
    ...
    <!-- <div class="relative flex justify-center flex-col overflow-hidden h-full">
        ...
        <div class="mt-3 relative flex overflow-hidden justify-center text-center lg:flex lg:items-center">
      ...
      <div class="mt-2 flex items-center text-sm text-gray-500">
          <svg class="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            Closing on January 9, 2020
                ...
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Shortener Link</h2>
            </div>
            <br>
            <div class="text-center lg:mt-0 ml-4 mr-5">
